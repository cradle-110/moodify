...
config_data = {'SPOTIFY_CLIENT_ID': SPOTIFY_CLIENT_ID, 'SPOTIFY_CLIENT_SECRET': SPOTIFY_CLIENT_SECRET}
...
oauth.register(
    ...
    client_kwargs={'scope': 'user-read-private, user-library-read'},  # Adjust scope as needed
)
